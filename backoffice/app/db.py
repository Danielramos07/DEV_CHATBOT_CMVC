...
def ensure_schema() -> None:
    ...
    try:
        ...
        # Chatbot language (used by UI + FAQ filtering + TTS voice selection)
        cur.execute("ALTER TABLE chatbot ADD COLUMN IF NOT EXISTS idioma VARCHAR(20) NOT NULL DEFAULT 'pt';")
        # Backfill any legacy null/empty values
        cur.execute("UPDATE chatbot SET idioma='pt' WHERE idioma IS NULL OR TRIM(idioma) = ''; ")
        ...
        # Message appended/shown when the answer was generated by AI (RAG)
        cur.execute("ALTER TABLE chatbot ADD COLUMN IF NOT EXISTS mensagem_gerada_ai TEXT;")
